...
`AI 的能力上限 = 模型能力 × 数据质量`，现在 AI 爱好者认知的空白主要在于：**大家很多没有看到 AI 能力的另一半——数据**。
...
学完之后，你将能够与 AI 技术团队对话，理解 Agent、RAG、Memory、Skill、MCP 这些概念在产品设计中的含义，能够评估一个 AI 功能的可行性，知道数据层的选择如何影响产品体验。你将不再是那个只会说“换个更好的模型”的人，而是能从数据视角审视 AI 产品全貌的领航者。
...
![](https://raw.githubusercontent.com/datawhalechina/easy-data-x-ai/main/docs/public/images/base_knowledge/F0/F0-20.png)
