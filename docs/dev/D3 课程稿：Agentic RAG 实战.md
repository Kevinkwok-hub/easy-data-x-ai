...
在这次运行里，混合检索让 Hit@1 提高了 **16 个百分点**，代价是 P95 增加 **10.0%**、平均上下文 Token 增加 **37.3%**。
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 纯向量基线 | 0.76 | 0.60 | 1.65 | 1.00 | 12651 |
| 混合检索 | 0.98 | 1.00 | 1.75 | 1.00 | 14691 |
| 工程管线 | 1.00 | 1.00 | 4.46 | 2.73 | 15124 |
